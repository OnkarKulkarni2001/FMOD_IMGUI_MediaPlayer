...
void cMediaPlayer::AdjustPitch(float pitch) { ImGui::Text("Adjusting Pitch..."); }
void cMediaPlayer::AdjustVolume(float volume) { ImGui::Text("Adjusting Volume..."); }
void cMediaPlayer::AdjustPan(float pan) { ImGui::Text("Adjusting Pan..."); }

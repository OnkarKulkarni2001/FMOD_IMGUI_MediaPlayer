...
void cAudioManager::DisplayProgressBar(float progress, int barWidth = 100) {
    int currentPosition = barWidth * progress;
    std::cout << "[";
    for (int i = 0; i < barWidth; ++i) {
        if (i < currentPosition) std::cout << "=";
        else std::cout << " ";
    }

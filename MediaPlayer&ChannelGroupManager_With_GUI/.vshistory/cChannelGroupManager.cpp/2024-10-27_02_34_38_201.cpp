...
void cChannelGroupManager::SetChannelGroupDSP() {
    ...
    m_ChannelGroup->getName(channel_name, sizeof(channel_name));
    if (channel_name == "Scene 01: Forest Ambience(Lively)") {
        SetChannelGroupDSP(0.7f, 300.0f);
    }
    if (channel_name == "Scene 02: Horror (Probably You Shouldn't hear this)") {
        SetChannelGroupDSP(0.2f, 3000.0f);
    }
    if (channel_name == "Scene 03: Port Control (Communication)") {
        SetChannelGroupDSP(1.7f, 30.0f);
    }
}

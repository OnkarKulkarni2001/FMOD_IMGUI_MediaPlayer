...
void cMediaPlayer::RunMediaPlayer(GLFWwindow* window) {
    ...
    while (bIsRunning) {
        ...
        if (selectedSongIndex != -1) {  // Ensure a song is selected
            ...
            if (ImGui::SliderFloat("Volume", &audioManager.volumeValue, 0.0f, 1.0f)) {
        ...
        if (selectedSongIndex != -1) {  // Ensure a song is selected
            ...
            if (ImGui::SliderFloat("Pitch", &audioManager.pitchValue, 0.0f, 1.0f)) {
        ...
        if (selectedSongIndex != -1) {  // Ensure a song is selected
            ...
            if (ImGui::SliderFloat("Pan", &audioManager.panValue, 0.0f, 1.0f)) {

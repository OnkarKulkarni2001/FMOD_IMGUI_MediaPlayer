...
void cMediaPlayer::RunMediaPlayer(GLFWwindow* window) {
    ...
    while (bIsRunning) {
        ...
        if (ImGui::Button("Pause")) {
            PauseAudio(selectedSongIndex, channelGroupManager.channel);
        }
        if (ImGui::Button("Resume")) {
            channelGroupManager.resume(selectedSongIndex, channelGroupManager.channel);
        }
        if (ImGui::Button("Stop")) {
            StopAudio(selectedSongIndex, channelGroupManager.channel);
        }
...
void cMediaPlayer::StopAudio(int index, FMOD::Channel* channel) {
    channelGroupManager.stop(index, channelGroupManager.getChannelGroup());
}

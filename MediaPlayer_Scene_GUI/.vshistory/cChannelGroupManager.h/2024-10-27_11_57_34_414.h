...
public:
	...
	void SetChannelGroupDSP(float distortionLevel, float echo);
	...
	void SetListenerPosition(FMOD_VECTOR newListenerPosition);
	void SetSoundPosition(FMOD_VECTOR newSoundPosition);

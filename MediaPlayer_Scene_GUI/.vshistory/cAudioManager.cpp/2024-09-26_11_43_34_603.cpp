...
void cAudioManager::setVolume() {
    ...
    if (channel) {
        ...
        if (bIsPlaying) {
            ...
            volumeValue = channel->getVolume(&volumeValue);
                ...
                if (_kbhit()) {
                    ...
                    if (key == 72) {
                        ...
                        if (volumeValue >= 10.0) {
                            ...
                            result = channel->setVolume(volumeValue);
                            cout << "Volume set to maximum value of 10! Exiting pitch controls..." << endl;
                        }
                        result = channel->setVolume(volumeValue);
                        cout << "New Volume: " << volumeValue << endl;
                    }
                    if (key == 80) {
                        ...
                        if (volumeValue <= 0.1) {
                            ...
                            result = channel->setVolume(volumeValue);
                            cout << "New Volume: " << volumeValue << endl;
                            cout << "Volume set to minimum value of 0! Exiting pitch controls..." << endl;
                            return;
                        }
                        result = channel->setVolume(volumeValue);
                        cout << "New Volume: " << volumeValue << endl;

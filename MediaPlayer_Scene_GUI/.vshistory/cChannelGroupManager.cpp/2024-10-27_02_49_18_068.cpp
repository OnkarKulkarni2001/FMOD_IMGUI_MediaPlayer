...
void cChannelGroupManager::LoadScene() {
    if (ImGui::Button("Scene 01: Forest Ambience (Lively)")) {
        ...
        //distortionDSP->setParameterFloat(FMOD_DSP_DISTORTION_LEVEL, 0.7f);
        //echoDSP->setParameterFloat(FMOD_DSP_ECHO_DELAY, 300.0f);
    ...
    if (ImGui::Button("Scene 02: Horror (Probably You Shouldn't hear this)")) {
        ...
        SetChannelGroupDSP(0.2f, 3000.0f);
...
void cChannelGroupManager::applyDSPsToChannelGroup() {

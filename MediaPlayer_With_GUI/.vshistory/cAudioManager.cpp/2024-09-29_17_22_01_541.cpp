...
void cAudioManager::play(int index) {
    ...
    if (bIsPlaying) {
        ...
        if (ImGui::Button("Play")) {
            ...
            FMOD::FMOD_RESULT result = fmodSystem->playSound(sounds[userInput], nullptr, false, &channel);
            if (result == FMOD_OK) {
                bIsPlaying = true;
    ...
    if (ImGui::BeginPopupModal("Stop Confirmation", nullptr, ImGuiWindowFlags_AlwaysAutoResize)) {
        ...
        if (ImGui::Button("Yes")) {
            ...
            FMOD::FMOD_RESULT result = fmodSystem->playSound(sounds[currentSoundIndex], nullptr, false, &channel);
            if (result == FMOD_OK) {
                bIsPlaying = true;
                std::cout << "Enjoy listening..." << std::endl;
            }
